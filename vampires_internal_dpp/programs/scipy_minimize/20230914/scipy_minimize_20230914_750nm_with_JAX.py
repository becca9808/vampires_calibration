...
# Example call to internal_calibration_mueller_matrix function
theta_pol = 0
HWP_angs = jnp.array([0., 11.25, 22.5, 33.75, 45., 56.25, 67.5, 78.75])
IMR_angs = jnp.array([45., 57.5, 70., 82.5, 95., 107.5, 120., 132.5])
fixed_params = {
...
# Call the function
output = instrument_matrices.internal_calibration_mueller_matrix(
    theta_pol=theta_pol,
    model_params=model_params,
    fixed_params=fixed_params,
    HWP_angs=HWP_angs,
    IMR_angs=IMR_angs,
    wollaston_properties=wollaston_properties
)
